...
Feature: Registering demo user
  ...
  Scenario Outline: To test the register user functinality with multiple set of data
    ...
    And email as "<email>", DateOfDemo as "<DoD>", ConvinientTimeHour as "<Hour>", ConvinientTimeMin as "<Min>" and MobileNumber as "<MobileNumber>"
    ...
    Examples: 
      | FirstName | LastName | Gender | StreetAddress | BuildingName | City      | State     | Zipcode | Country | email          | DoD         | Hour | Min | MobileNumber | CourseOne          | CourseTwo | CourseThree        | Query      | VerNum |
      | Sai       | Charan   | Male   | Madhapur      | SaiKuteer    | Hyderabad | Telangana |  500081 | India   | abcd@gmail.com | 17-Jul-2023 |   07 |  10 | 689461268961 | Selenium WebDriver | TestNG    | Core Java          | Test Query |     99 |
      | Charan    | Sai      | Male   | Madhapur      | Sai Kuteer   | Hyderabad | Telangana |  500081 | India   | efgh@gmail.com | 31-Jul-2023 |   07 |  10 |   9874965169 | Selenium WebDriver | TestNG    | Functional Testing | Test query |     99 |
